...
'''
 Request client form data and insert into clients mongo db collection.
client data:
_id
nome
foto
...
ative = boolean
__v = 0
planilha = 63e6d07f0b4b9fccda6cbb06
...
def create_product():
            ...
            if request.method == 'POST':
                ...
                if not nome:
                    ...
                    #collections.insert_one({'title': title, 'content': content})
                    products.insert_one({'nome': nome, 'preco': preco, 'descricao': descricao, 'categoria': categoria, 'imagem': imagem})
